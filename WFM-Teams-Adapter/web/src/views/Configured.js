  ...
  render() {
    ...
    let content =
      <TextComponent className={this.props.className}>
        <h3>You are connected to <b>{this.props.wfmBuName}</b> business unit.</h3>
        {buttonOrText}
        <p>If you experience any problems, please contact your Teams administrator.</p>
      </TextComponent>;

    if (this.props.wfmBuName.length === 0) {
      content =
        <TextComponent className={this.props.className}>
          This team is already connected to the <b>WFM Provider for shifts integration.</b>
          <br/><br/>
