...
namespace WfmTeams.Connector.BlueYonder.Localization
{
    using System;
    ...
    {
        //TODO: this is a copy of the exact same class in the Functions app and should ideally be in the WfmTeams.Adapter project
        // however, need to deal with the LoadCache mechanism which expects to find the resources in the same assembly
