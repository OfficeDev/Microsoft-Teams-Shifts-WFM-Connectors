// ---------------------------------------------------------------------------
// <copyright file="MicrosoftGraphShiftThemeMap.cs" company="Microsoft">
...
namespace WfmTeams.Adapter.MicrosoftGraph.Mappings
{
    ...
    public class MicrosoftGraphShiftThemeMap : IShiftThemeMap
    {
        ...
        public string MapTheme(string themeCode)
        {
            ...
            // it has been observed that DbConnectionStringBuilder lower cases the key values so
            // ensure matches by lower casing the themeCode
            ...
            {
                // there has been an error (possibly the colour code is not valid), so just return
                // the fall back colour
                return fallbackColour;
            }
        }
