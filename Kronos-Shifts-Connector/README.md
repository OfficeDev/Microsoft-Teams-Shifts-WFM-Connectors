...
* **FLMs are not to approve Open Shift Requests, Swap Shift Requests, and Time Off Requests in the Shifts UI. By doing so, the data being synced between Kronos WFC and Microsoft Shifts will be inconsistent between the two systems.**
