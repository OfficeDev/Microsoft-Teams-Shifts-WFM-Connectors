...
namespace Microsoft.Teams.App.KronosWfc.BusinessLogic.TimeOff
{
    ...
    public class TimeOffActivity : ITimeOffActivity
    {
        ...
        /// <returns>Request details response object.</returns>
        public async Task<TimeOffResponse.CancelTimeOff.Response> CancelTimeOffRequestAsync(
            Uri endPointUrl,
            string jSession,
            string queryDateSpan,
            ...
            string kronosId)
        {
            ...
            return tupleResponse.ProcessResponse<TimeOffResponse.CancelTimeOff.Response>(this.telemetryClient);
        }
            ...
            string kronosId)
        {
            ...
            return tupleResponse.ProcessResponse<TimeOffResponse.TimeOffApproveDecline.Response>(this.telemetryClient);
        }
