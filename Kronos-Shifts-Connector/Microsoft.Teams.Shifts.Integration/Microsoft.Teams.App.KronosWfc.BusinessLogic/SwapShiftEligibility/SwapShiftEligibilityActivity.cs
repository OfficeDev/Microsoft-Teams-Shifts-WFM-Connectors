...
namespace Microsoft.Teams.App.KronosWfc.BusinessLogic.SwapShiftEligibility
{
    ...
    /// </summary>
    public class SwapShiftEligibilityActivity
    {
            ...
            string employeeNumber)
        {
            var request =
                new Request
                {
                    ...
                    SwapShiftEmployees = new SwapShiftEmployeesTag()
                    {
                        StartTime = startTime,
                        EndTime = endTime,
                        QueryDate = queryDate,
                        ShiftSwapDate = shiftSwapDate,
                        Employee = new EmployeeTag()
                        {
                            PersonIdentity = new PersonIdentityTag() { PersonNumber = employeeNumber },
                        },
                    },
                };
