...
namespace Microsoft.Teams.Shifts.Encryption.Encryptors
{
    ...
    /// <summary>
    /// Aes256CbcHmacSha256Encryptor, based off of Microsoft.Internal.M365.Security.Encryption.EncryptionManager by Filip Sebesta [filipse@microsoft.com], Andrey Belenko [anbelen@microsoft.com]
    /// </summary>
    /// <remarks>Stripped down version of Aes256CbcHmacSha256Encryptor that we can give to developers to decrypt based on a shared secret </remarks>
    public class Aes256CbcHmacSha256Encryptor
    {
        /// <summary>
        /// The encryption key identifier, currently we only keep a single key.
        /// </value>
        ...
        /// </summary>
        /// <param name="masterKey">Master key associated with the class. This will be used to encrypt/decrypt data.</param>
...
#pragma warning restore CA1303 // Do not pass literals as localized parameters
            ...
            // Split supplied master key into authentication key (32 bytes, first half) and key encryption key (32 bytes, second half)
            ...
            // Create encryption instance for record key encryption (key length = 32B, cipher mode = ECB, no padding)
            // There is no need for padding as the key is exactly two blocks
        ...
        /// <summary>
        /// Creates Additional Authenticated Data, keyed by KeyId.
        /// If/when KeyId changes, adds an additional level of security.
        /// </summary>
        ...
        public byte[] Encrypt(byte[] plaintext)
        {
            ...
            Serialize.To(encryptWriter, new EncryptionManagerPayload
            {
                KeyID = KeyId,
