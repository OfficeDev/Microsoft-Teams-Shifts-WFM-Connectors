...
namespace Microsoft.Teams.Shifts.Integration.BusinessLogic.Providers
{
    ...
    public interface IOpenShiftRequestMappingEntityProvider
    {
        ...
        /// <summary>
        /// Obtaining the open shift request mapping entity by the open shift request ID from Shifts.
        /// </summary>
        ...
        Task<AllOpenShiftRequestMappingEntity> GetOpenShiftRequestMappingEntityByOpenShiftRequestIdAsync(
        ...
        /// <returns>A unit of execution that contains the Open Shift Request mapping entity.</returns>
        Task<AllOpenShiftRequestMappingEntity> GetOpenShiftRequestMappingEntityByOpenShiftIdAsync(string openShiftId, string openShiftReqId);
    }
}