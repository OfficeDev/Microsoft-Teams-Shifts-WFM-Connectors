...
namespace Microsoft.Teams.Shifts.Integration.API.Controllers
{
    ...
    public class SyncKronosToShiftsController : ControllerBase
    {
        ...
        private async Task ProcessKronosToShiftsShiftsAsync(string isRequestFromLogicApp)
        {
            ...
            bool isOpenShiftRequestSyncSuccessful = await this.ProcessTask(this.openShiftRequestController.ProcessOpenShiftsRequestsAsync(isRequestFromLogicApp), Resource.ProcessOpenShiftsRequests).ConfigureAwait(false);
